...
\part{Veille technique}
    ...
    \chapter{Outils d'analyse}
    	Lors de la réalisation de notre crawler et des stratégies de masquage qu'il implémente, nous avons du analyser les traces qu'il laisse sur un site.
		...
		\section{Urchin}
			...
			Si un pic entre 0-10 secondes se fait ressentir, il est possible que cela soit du à un automate.
...
\part{Application: Réalisation d'une crawler avec proxy}
	...
	\chapter{Utilisation de stratégies de masquage}
		...
		\section{Limite de requêtage}
			...
			En effet la classe mère gère déjà les accès concurrent.
